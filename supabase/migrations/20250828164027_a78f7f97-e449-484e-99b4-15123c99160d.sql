...
BEGIN
    ...
    IF user_count > 0 THEN
        -- Insert sample scores for existing users (excluding total_score since it's generated)
        INSERT INTO public.scores (user_id, day_problem_id, code_score, video_score)
        SELECT 
            p.user_id,
            dp.id,
